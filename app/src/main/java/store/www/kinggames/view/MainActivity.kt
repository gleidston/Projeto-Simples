...
import kotlinx.android.synthetic.main.activity_main.rv_menu_items
...
import store.www.kinggames.data.NavMenuItemsDataBase
import store.www.kinggames.domain.NavMenuItem
import store.www.kinggames.domain.User
import store.www.kinggames.util.NavMenuItemDetailsLookup
import store.www.kinggames.util.NavMenuItemPredicate
...
class MainActivity :
   ...
   // private fun getFragment( fragId: Long ): Fragment
    ...
    fun updateToolbarTitleInFragment( titleStringId: Int ){
        ...
        // nao consigo localizar a string no aboutxml por isso o erro persiste
    }
